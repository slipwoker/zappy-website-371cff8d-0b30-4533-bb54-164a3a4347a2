document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fields.forEach(function (field) {
      ...
      if (field.hasAttribute('required') && value === '') {
        ...
        if ((type === 'tel' || name.toLowerCase().includes('phone') || name.toLowerCase().includes('tel')) && type !== 'email') {
  ...
  function showFormSuccess(form) {
    ...
    msgEl.textContent = form.dataset.successMessage || 'Thank you! Your message has been sent successfully.';
  ...
  const animatedElements = document.querySelectorAll(
    '.fade-in, [data-animate], .animate-on-scroll, section > *, .hero *, .features *, .services *, .testimonials *, .pricing *, .cta *'
  );
  ...
  if ('IntersectionObserver' in window) {
    ...
    animatedElements.forEach(function (el, index) {
      if (!el.dataset.animateDelay && !el.dataset.delay) {
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '371cff8d-0b30-4533-bb54-164a3a4347a2',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '371cff8d-0b30-4533-bb54-164a3a4347a2';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '371cff8d-0b30-4533-bb54-164a3a4347a2';
